...
#include "BehaviorPlanner/FSMPlanner.h"
#include "SplineBasedLeftChangeCapablePlanner.h"
...
int main(int argc, char * argv[])
{
	...
	CostCalculator costCalculator(map);
	FSMPlanner pathPlanner(map, StartingLane, costCalculator);
//	SplineBasedLeftChangeCapablePlanner pathPlanner(map, StartingLane, .0);
